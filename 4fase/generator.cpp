...
void bezAux(float t, float *p0, float *p1, float *p2, float *p3, float *res){
    ...
    /* res[0] = (t*t*t)*p0[0] + (t*t)*p1[0] + t*p2[0] + p3[0]; */
    /* res[1] = (t*t*t)*p0[1] + (t*t)*p1[1] + t*p2[1] + p3[1]; */
    /* res[2] = (t*t*t)*p0[2] + (t*t)*p1[2] + t*p2[2] + p3[2]; */
...
void draw_sphere( char* ofile, float raio, float slices, float stacks ){
    ...
    float textL = (2*M_PI) / slices;
    float textT = M_PI / stacks;
    float textSl = 1.0 / slices;
    ...
    for( i = 0; i < slices; i++ ){
        for( j = 0; j <= stacks; j++ ){
            ...
            // normal
            file << x11/raio << " " << y11/raio << " " << z11/raio << endl;
            // texture
            file << textSl*(i) << " " << textSt*(j) << endl;
            // file << "0.0" << " " << "0.0" << endl;

            // point
            file << x22 << " " << y22 << " " << z22 << endl;
            // normal
            file << x22/raio << " " << y22/raio << " " << z22/raio << endl;
            // texture
            file << textSl*(i+1) << " " << textSt*(j+1) << endl;
            // file << "1.0" << " " << "1.0" << endl;

            // point
            file << x21 << " " << y21 << " " << z21 << endl;
            // normal
            file << x21/raio << " " << y21/raio << " " << z21 << endl;
            // texture
            file << textSl*(i+1) << " " << textSt*(j) << endl;
            // file << "1.0" << " " << "0.0" << endl;
            }
            ...
            // normal
            file << x12/raio << " " << y12/raio << " " << z12/raio << endl;
            // texture
            file << textSl*(i) << " " << textSt*(j+1) << endl;
            // file << "0.0" << " " << "1.0" << endl;
